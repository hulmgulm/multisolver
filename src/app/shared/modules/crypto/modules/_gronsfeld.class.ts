...
import { Gronsfeld } from './gronsfeld.class';
...
export class _Gronsfeld extends Gronsfeld {

    private _Identifier:string = "GRONSFELD";
    ...
    private checkConstraints():boolean {
       return PasswordContainers.getInstance().getData("Digits").length > 0
