...
import { Atbash } from './atbash.class';
import { DataContainers } from '../data-containers/dataContainers.class';

export class _Atbash extends Atbash {

    private _Identifier:string = "ATBASH";
    ...
    public do() {
        ...
        if ( this.checkConstraints() ) {
            returnData.data = super.decipher(DataContainers.getInstance().getData("Trimmed"));
        }
